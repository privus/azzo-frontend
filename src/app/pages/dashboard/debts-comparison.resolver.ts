...
export class DebtsComparisonResolver implements Resolve<DebtsComparisonReport> {
  ...
  resolve(): Observable<DebtsComparisonReport> {
    ...
    return this.debtsService.getPerformanceDebts(fromDate1, toDate1, fromDate2, toDate2);
  }
